...
public class CatalogPage {
    ...
    private final static String SEARCH_BUTTON = "top_search_button";
   ...
   private final static String TOP_BASKET = "//a[@class='top_block_link basket']";
    ...
    private final static String SIZE_OF_PRODUCT_IN_BASKET = "basket_size_box";
    ...
    public void searchForProducts(String productCategory) {
        driver.findElement(By.xpath(SEARCH_FIELD)).sendKeys(productCategory);
    ...
    public Product getFirstProductFromBasket() {
        ...
        product.size = driver.findElement(By.className(SIZE_OF_PRODUCT_IN_BASKET)).getText();
